...
class Calculator {
	...
	private void initialize() {
		...
		frmCalculator.getContentPane().setBackground(new Color(255, 255, 255, 128));
		...
		button12.setBackground(new Color(1, 94, 35));
		...
		button13.setBackground(new Color(1, 94, 35));
		...
		button14.setBackground(new Color(1, 94, 35));
		...
		button17.setBackground(new Color(1, 94, 35));
		...
		button18.setBackground(new Color(1, 94, 35));
		...
		button19.setBackground(new Color(1, 94, 35));
		...
		button22.setBackground(new Color(1, 94, 35));
		...
		button23.setBackground(new Color(1, 94, 35));
		...
		button24.setBackground(new Color(1, 94, 35));
		...
		button28.setBackground(new Color(1, 94, 35));
